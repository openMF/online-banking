...
AccountsModule = __decorate([
    NgModule({
        declarations: [AccountsComponent, SavingsAccountDetailsComponent, LoanAccountDetailsComponent, SavingsAccountsListComponent, LoanAccountsListComponent, ShareAccountsListComponent],
        imports: [
            SharedModule,
